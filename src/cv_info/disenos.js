...
/**
 * Ruta de la portada de un idioma.
 *
 * Dentro de la vista previa de un diseno hay que QUEDARSE en /vista/<diseno>/:
 * con el enlace al sitio normal, cambiar de idioma devolvia al diseno activo y
 * parecia que la comparacion se hubiera perdido sola.
 */
export const rutaDePortada = (raiz, codigo, diseno) =>
  diseno ? `${raiz}vista/${diseno}/${codigo}` : `${raiz}${codigo}/`;
